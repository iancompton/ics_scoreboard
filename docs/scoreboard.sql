...
--
-- TOC entry 2818 (class 0 OID 51360)
-- Dependencies: 199
-- Data for Name: game; Type: TABLE DATA; Schema: scoreboards; Owner: postgres
--

COPY scoreboards.game (id, name) FROM stdin;
\.


--
-- TOC entry 2821 (class 0 OID 51371)
-- Dependencies: 202
-- Data for Name: gameuser; Type: TABLE DATA; Schema: scoreboards; Owner: postgres
--

COPY scoreboards.gameuser (id, gameid, userno) FROM stdin;
\.


--
-- TOC entry 2817 (class 0 OID 51355)
-- Dependencies: 198
-- Data for Name: score; Type: TABLE DATA; Schema: scoreboards; Owner: postgres
--

COPY scoreboards.score (id, userno, gameid, timeadded, score) FROM stdin;
1	1	1	2019-05-30 23:00:00	10
2	1	1	2019-05-30 23:05:00	20
3	2	2	2019-05-30 23:30:00	200
\.


--
-- TOC entry 2816 (class 0 OID 51350)
-- Dependencies: 197
-- Data for Name: user; Type: TABLE DATA; Schema: scoreboards; Owner: postgres
--

COPY scoreboards."user" (userid, uniqueuserno, firstname, lastname) FROM stdin;
\.
